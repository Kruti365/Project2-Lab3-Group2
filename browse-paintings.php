          ...
          <li class="item">
            ...
            <div class="content">
              ...
              <div class="extra">
                ...
                <a class="ui icon button" href="addToFavourites.php?id=<?php echo $work['PaintingID']; ?>&image=<?php echo $work['ImageFileName']; ?>&title=<?php echo $work['Title']; ?>"><i class="heart icon"></i></a>          
              </div>        
            </div>      
          </li>
